...
console.log(tyrannos.weight);

// What was the diet of a velociraptor?
console.log(veloc.diet);

// How long was a stegosaurus?
console.log(stegas.length);

// What time period did tyrannosaurus live in?
console.log(tyrannos.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannos.roar());
...
*/
const animalNames = [];
let displayNames = zooAnimals.forEach(function(i){
...
let largerPopulation = zooAnimals.filter((animals) => {
